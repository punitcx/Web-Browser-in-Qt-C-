...
public:
    ...
    QMenuBar *menuBar;
    QMenu *menuRecently_Closed_Tabs;
    QMenu *menuFile;
    QMenu *menuEdit;
    QMenu *menuView;
    QMenu *menuPage_Look;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->setMinimumSize(QSize(647,400));
        ...
        actionDownloads->setEnabled(true);
        ...
        actionToolbars->setChecked(true);
        ...
        actionSidebars->setChecked(true);
        ...
        menuRecently_Closed_Tabs = new QMenu(menuHistory);
        menuRecently_Closed_Tabs->setObjectName(QStringLiteral("menuRecently_Closed_Tabs"));
        ...
        menuHistory->addAction(menuRecently_Closed_Tabs->menuAction());
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "Creation - 1.0", 0));
        ...
        actionFind_Replace->setText(QApplication::translate("MainWindow", "Find", 0));
        ...
        actionHelp->setText(QApplication::translate("MainWindow", "About Creation", 0));
        ...
        actionAbout_Aurora->setText(QApplication::translate("MainWindow", "About Qt", 0));
        ...
        actionAddBookmark->setText(QApplication::translate("MainWindow", "Add Bookmark", 0));
        ...
        menuRecently_Closed_Tabs->setTitle(QApplication::translate("MainWindow", "Recently Closed Tabs", 0));
        actionWeb_Console->setText(QApplication::translate("MainWindow", "Web Inspector", 0));
